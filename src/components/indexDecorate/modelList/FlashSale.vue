<template>
  <div class="nearby-service">
    ...
    <div class="section-body">
      <div class="service-card" v-for="i in 5" :key="i">
        <div class="card--top">
          <img :src="mockImg[i-1]" alt=""/>
        ...
        <div class="card--content">
          <div class="meta-info">
            <h3>Trải Nghiệm Suối Nước Nóng Kawara Mỹ An Ở Hà Nội</h3>
...
export default {
  ...
  data() {
    return {
      ...
      //   MOCK
      mockImg: [
        'https://images.unsplash.com/photo-1580618672591-eb180b1a973f?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8Mnx8aGFpciUyMHNhbG9ufGVufDB8fDB8fHww&auto=format&fit=crop&w=500&q=60',
        'https://images.unsplash.com/photo-1632345031435-8727f6897d53?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8NXx8bmFpbHxlbnwwfHwwfHx8MA%3D%3D&auto=format&fit=crop&w=500&q=60',
        'https://plus.unsplash.com/premium_photo-1683141179185-019966ae7ed6?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MXx8c2F1bmF8ZW58MHx8MHx8fDA%3D&auto=format&fit=crop&w=500&q=60',
        'https://plus.unsplash.com/premium_photo-1661274108346-6e831c83d33e?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8NDl8fHNwYXxlbnwwfHwwfHx8MA%3D%3D&auto=format&fit=crop&w=500&q=60',
        'https://images.unsplash.com/photo-1570172619644-dfd03ed5d881?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8M3x8c2tpbmNhcmV8ZW58MHwwfDB8fHww&auto=format&fit=crop&w=500&q=60'
      ],
    }
  },
  mounted() {
