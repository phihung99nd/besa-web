    ...
    <swiper :options="swiperOption" ref="mySwiper">
      <swiper-slide v-for="(item,index) in goodsList" :key="index">
        <div class="content hover-pointer"  @click.stop="goToSeckill">
          <img :src="item.goodsImage" width="140" height="140" :alt="item.name">
          <div class="ellipsis">{{item.name}}</div>
          <div>
            <span>{{ item.price | unitPrice("₫",  "before") }}</span>
            <span>{{ item.originalPrice | unitPrice("₫",  "before") }}</span>
          </div>
        </div>
      </swiper-slide>
...
export default {
  ...
  methods: {
    ...
    getListByDay () { // 当天秒杀活动
      ...
      //     timeLine: 18,
      //     seckillGoodsList: [
      //       {goodsImage: 'https://lilishop-oss.oss-cn-beijing.aliyuncs.com/a9593607de404546953055f279fd5d54.png', name: 'dfsdgsdf', originalPrice: 39, price: 12},
      //       {goodsImage: 'https://lilishop-oss.oss-cn-beijing.aliyuncs.com/a9593607de404546953055f279fd5d54.png', name: 'dfsdgsdf', originalPrice: 39, price: 12},
      //       {goodsImage: 'https://lilishop-oss.oss-cn-beijing.aliyuncs.com/a9593607de404546953055f279fd5d54.png', name: 'dfsdgsdf', originalPrice: 39, price: 12},
      //       {goodsImage: 'https://lilishop-oss.oss-cn-beijing.aliyuncs.com/a9593607de404546953055f279fd5d54.png', name: 'dfsdgsdf', originalPrice: 39, price: 12},
      //       {goodsImage: 'https://lilishop-oss.oss-cn-beijing.aliyuncs.com/a9593607de404546953055f279fd5d54.png', name: 'dfsdgsdf', originalPrice: 39, price: 12},
