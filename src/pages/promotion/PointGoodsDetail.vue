        ...
        <div class="item-detail-price-row">
          <div class="item-price-left">
            ...
            <div class="item-price-row">
              <p>
                <span class="item-price-title">{{$t('Item point')}}</span>
        ...
        <div class="add-buy-car-box">
          <div class="item-select">
            ...
            <div class="item-select-row">
              ...
              <span class="inventory"> {{ $t('In Stock: {0}', [goodsSku.quantity]) }}</span>
            </div>
          </div>
          ...
          <div class="add-buy-car">
            <Button type="error" :loading="loading" :disabled="goodsSku.quantity === 0" @click="pointBuy">{{ $t('Point Pay') }}</Button>
          </div>
        </div>
      </div>
    </div>
